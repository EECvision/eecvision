...
**Senior Front-End Engineer** | React.js • Next.js • TypeScript
...
- **Performance Optimization:** Core Web Vitals, Code Splitting, Bundle Optimization
- **Component Architecture:** Reusable Design Systems, Scalable UI Patterns
- **API Integration:** REST, GraphQL, Authentication Flows
- **Testing:** Unit, Integration, E2E Testing Strategies
- **Collaboration:** Agile/Scrum, Code Reviews, Technical Documentation
- **Mentorship:** Training Junior Developers, Interview Engineering
...
**Open to remote opportunities and interesting frontend challenges**

⭐️ From [Emmanuel Ezeka](https://github.com/eecvision)
